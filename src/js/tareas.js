(function(){
    ...
    //botton para mostrar el modal de agregar tarea
    ...
    function mostrarTareas(){
        ...
        arrayTareas.forEach(tarea=>{
            ...
            btnEstadoTarea.classList.add(`${estados[tarea.estado].toLowerCase().split(" ").join("-")}`)
    ...
    function totalEnProceso(){
        const totalEnProceso = tareas.filter(tarea => tarea.estado === "1" );
        const enProcesoRadio = document.querySelector('#en-proceso');

        if(totalEnProceso.length === 0){
            enProcesoRadio.disabled = true;
        }else{
            enProcesoRadio.disabled = false;
        }
    }
    ...
    function mostrarFormulario(editar = false, tarea = {}){
        ...
        //primero se ejecuta el stack y luego el queue
        //el settimeout pertenece al queue
        setTimeout(() => {
    ...
    function cambiarEstadoTarea(tarea){
        const nuevoEstado = tarea.estado === "0" ? "1"
        : tarea.estado === "1" ? "2"
        : "0";
    ...
    async function actualizarTarea(tarea){
        ...
        try{
            ...
            if(resultado.respuesta.tipo === 'exito'){
                ...
                //verificando que tareas esta cambiando
    ...
    //Lee la url y nos retorna el id del proyecto 
